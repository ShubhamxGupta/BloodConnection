            ...
            <div className="max-w-7xl mx-auto px-6 lg:px-12 flex flex-col md:flex-row items-center justify-between min-h-[90vh]">
                ...
                >
                    ...
                    <p className="mt-4 text-lg text-gray-600">
                        Every drop counts! Help those in need by donating blood
                        or organs. Find donors nearby and make a difference
                        today.
                    </p>
                    ...
                    <div className="mt-6">
                        ...
                        >
                            ...
                            >
                                ...
                                Urgent blood needed? Request emergency donations
                                now!
                            </Link>
                        </motion.div>
                    </div>
                ...
                >
                    <video
                        ...
                        loop
                        muted
                        className="w-[90%] md:w-[80%] rounded-lg shadow-lg mx-auto md:mx-0"
                    >

    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await fetch(
                `http://localhost:5000/api/hospitals/${hospitalId}/reviews`,
                {
                    method: "POST",
                    headers: {
...
const RequestForm = ({ hospitalId }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            toast.success(
                "Request sent successfully! Hospital will contact you within 30 minutes."
            );
            ...
            <div className="max-w-4xl mx-auto">
                ...
                <div className="bg-white rounded-lg shadow-lg p-6 mb-8">
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                        {hospital?.inventory &&
                            Object.entries(hospital.inventory).map(
                                ([type, quantity]) => (
                                    <div
                                        key={type}
